...
<div class="content">    
    <form method="post" action="<?php echo base_url();?>administrator/campaigns/add" class="stdform" id="formID">
        <div class="edit-main">                
            ...
            <p><textarea name="txtcontent1" id="editor_content1" class="validate[required]"></textarea></p>            
            </br>
            <p><label>Phương thức tính giải:</label></p>                            
            <p><textarea name="txtcontent2" id="editor_content2" class="validate[required]"></textarea></p>            
            </br>
            <p><label>Hệ thống giải thưởng:</label></p>                            
            <p><textarea name="txtcontent3" id="editor_content3" class="validate[required]"></textarea></p>            
            </br>
        </div>
