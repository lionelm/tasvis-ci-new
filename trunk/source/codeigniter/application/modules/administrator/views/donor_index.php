...
<div class="content">                	
    <div class="edit-left">
        <form action="<?php echo base_url();?>administrator/donors" method="post" accept-charset="utf-8" id="formID" class="stdform">                    		
            <p><label>Tên nhà tài trợ:</label></p>
            <p><span class="field"><input name="txtname" value="" id="txttitle" class="longinput validate[required]" type="text"></span></p>
            <br>
            <p><label>Mô tả:</label></p>
            <p><span class="field"><input class="longinput validate[required]" name="txtdesc" type="text"></span></p>
            <br>  
            <p><label>Url:</label></p>
            <p><span class="field"><input class="longinput validate[required,custom[url]" name="txturl" type="text"></span></p>
            <br>            
