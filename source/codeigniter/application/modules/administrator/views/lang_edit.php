<ul class="maintabmenu multipletabmenu">        
    <li  class="current"><a href="<?php echo base_url();?>administrator/languages">Cập nhật ngôn ngữ</a></li>    
</ul>
<div class="content">                	
        <div class="edit-left">
            <form action="<?php echo base_url();?>administrator/languages/edit" method="post" accept-charset="utf-8" id="formID" class="stdform">                    		
                <input type="hidden" value="<?php echo $language->id;?>" name="txtLangId">
                <p><label>Tên ngôn ngữ:</label></p>
                <p><span class="field"><input name="txttitle" value="<?php echo $language->name;?>" id="txttitle" class="longinput validate[required]" type="text"></span></p>
                <br>
                <p><label>Mã ngôn ngữ:</label></p>
                <p><span class="field"><input value="<?php echo $language->code;?>" class="longinput validate[required]" name="txtcode" type="text"></span></p>
                <br>            
