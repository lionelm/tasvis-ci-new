<ul class="maintabmenu multipletabmenu">
    ...
    <li class="current"><a href="<?php echo base_url();?>administrator/operations">Operations</a></li>
</ul>
<div class="content">    
    
        <div class="edit-left">
            <form action="<?php echo base_url();?>administrator/operations" method="post" accept-charset="utf-8" id="formID" class="stdform">                    		
