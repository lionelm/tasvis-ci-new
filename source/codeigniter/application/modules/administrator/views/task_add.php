<ul class="maintabmenu multipletabmenu">
    ...
    <li class="current"><a href="<?php echo base_url();?>administrator/tasks/">Tasks</a></li>   
    <li><a href="<?php echo base_url();?>administrator/operations">Operations</a></li>
</ul>
<div class="content">    
    
        <div class="edit-left">
            <form action="<?php echo base_url();?>administrator/tasks" method="post" accept-charset="utf-8" id="formID" class="stdform">                    		
    ...
    <div class="list-right">
        <div class="contenttitle radiusbottom0">
            <h2 class="table"><span>Danh sách Task</span></h2>
        </div><!--contenttitle-->
            ...
            <tbody>
                ...
                <tr>
                    <td class="center"><input value="<?php echo $auth->id;?>" type="checkbox"></td>
                        ...
                        <td class="center">
                            <a class="edit" title="Sửa" href="<?php echo base_url();?>administrator/tasks/edit/<?php echo $auth->id;?>">Sửa</a> &nbsp; 
                            <a class="delete" id="<?php echo $auth->id;?>" name="delete" title="Xóa Task" href="<?php echo base_url();?>administrator/tasks/delete">Xóa</a>
                        </td>
                </tr>
                <?php } ?>
            </tbody>
